...
from tests.samples.expected_values import (QVOLTHYBG33P_VALUES,
                                           X1_BOOST_VALUES,
                                           X1_HYBRID_G4_VALUES, X1_MINI_VALUES,
                                           X1_MINI_VALUES_V34, X1_SMART_VALUES,
                                           X1_VALUES, X3_HYBRID_VALUES,
                                           X3_VALUES, X3V34_HYBRID_VALUES,
                                           X3V34_HYBRID_VALUES_EPS_MODE,
                                           X3V34_HYBRID_VALUES_NEGATIVE_POWER,
                                           XHYBRID_VALUES)
from tests.samples.responses import (
    QVOLTHYBG33P_RESPONSE_V34, X1_BOOST_AIR_MINI_RESPONSE, X1_BOOST_RESPONSE,
    X1_HYBRID_G3_2X_MPPT_RESPONSE, X1_HYBRID_G3_RESPONSE,
    X1_HYBRID_G4_RESPONSE, X1_MINI_RESPONSE_V34, X1_SMART_RESPONSE,
    ...
    X3_MIC_RESPONSE, XHYBRID_DE01_RESPONSE, XHYBRID_DE02_RESPONSE)
