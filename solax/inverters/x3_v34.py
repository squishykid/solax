...
class X3V34(InverterPost):
    ...
    _sensor_map = {
        ...
        'Total PV Energy':                       (89, Total(Units.KWH),
                                                  pv_energy),
        ...
        'Total Energy':                          (19, Total(Units.KWH),
                                                  total_energy),
        ...
        'Total Battery Discharge Energy':        (30, Total(Units.KWH),
                                                  discharge_energy),
        ...
        'Total Battery Charge Energy':           (87, Total(Units.KWH),
                                                  charge_energy),
        ...
        'Total Feed-in Energy':                  (67, Total(Units.KWH),
                                                  feedin_energy),
        'Total Feed-in Energy Resets':           (68),
        'Total Consumption':                     (69, Total(Units.KWH),
                                                  consumption),
        ...
        'EPS Total Energy':                      (110, Units.KWH,
                                                  eps_total_energy),
