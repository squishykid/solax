...
class X3V34(InverterPost):
    ...
    def response_decoder(cls):
        return {
            ...
            "Total PV Energy": ((89, 90), Total(Units.KWH), div10),
            ...
            "Total Energy": ((19, 20), Total(Units.KWH), div10),
            ...
            "Total Battery Discharge Energy": ((30, 31), Total(Units.KWH), div10),
            "Today's Battery Discharge Energy": (113, Units.KWH, div10),
            "Battery Remaining Energy": (32, Units.KWH, div10),
            "Total Battery Charge Energy": ((87, 88), Total(Units.KWH), div10),
            "Today's Battery Charge Energy": (114, Units.KWH, div10),
            "Exported Power": (65, Units.W, to_signed),
            "Total Feed-in Energy": ((67, 68), Total(Units.KWH), div100),
            "Total Consumption": ((69, 70), Total(Units.KWH), div100),
            "AC Power": (181, Units.W, to_signed),
            "EPS Frequency": (63, Units.HZ, div100),
            "EPS Total Energy": ((110, 111), Units.KWH, div10),
        }
