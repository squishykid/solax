...
class QVOLTHYBG33P(InverterPost):
    ...
    _sensor_map = {
        ...
        'Inverter Operation mode':               (19, Units.UNKNOWN,
        ...
        # 55-67: always 0
        'Total Energy':                          (68, Total(Units.KWH),
                                                  total_energy),
        'Total Energy Resets':                   (69),
        # 70: div10, today's energy including battery usage
        # 71-73: 0
        'Total Battery Discharge Energy':        (74, Total(Units.KWH),
                                                  discharge_energy),
        'Total Battery Discharge Energy Resets': (75),
        'Total Battery Charge Energy':           (76, Total(Units.KWH),
                                                  charge_energy),
        ...
        'Total PV Energy':                       (80, Total(Units.KWH),
                                                  pv_energy),
        ...
        'Total Consumption':                     (88, Total(Units.KWH),
                                                  consumption),
        ...
        'Battery Operation mode':                (168, Units.UNKNOWN,
